...
}       // #g digunakan untuk membulatkan angka 14.00 menjadi 14, karena pada scanf menggunakan %f dan angka yg diinput berupa integer sehingga memunculkan koma dibelakang angka tesebut.
